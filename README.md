...
- [Playlist Builder Algorithm](#playlist-builder-algorithm)
  - [**Algorithm Overview with Updated Parameters**](#algorithm-overview-with-updated-parameters)
  - [**Applying the Algorithm to Your Example Request**](#applying-the-algorithm-to-your-example-request)
  - [**Detailed Steps**](#detailed-steps)
    - [**Step 1: Parse the Playlist Request**](#step-1-parse-the-playlist-request)
    - [**Step 2: Calculate the Distribution of Songs**](#step-2-calculate-the-distribution-of-songs)
    - [**Step 3: Build the Familiar Song Pool**](#step-3-build-the-familiar-song-pool)
    - [**Step 4: Build the New Song Pool**](#step-4-build-the-new-song-pool)
    - [**Step 5: LLM Playlist Curation**](#step-5-llm-playlist-curation)
    - [**Step 6: Create Final Playlist**](#step-6-create-final-playlist)
